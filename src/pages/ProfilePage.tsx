          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <button
                ...
                className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 backdrop-blur-sm rounded-2xl p-6 border border-yellow-500/30 hover:border-yellow-500/50 transition-all group text-left"
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 bg-yellow-500/20 rounded-lg group-hover:scale-110 transition-transform">
                    <span className="text-3xl">📔</span>
                  </div>
                  <ChevronRight className="w-6 h-6 text-yellow-500/60 group-hover:text-yellow-500 group-hover:translate-x-1 transition-all" />
                </div>
