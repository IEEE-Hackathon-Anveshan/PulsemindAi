  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Consequences */}
        <div className="bg-yellow-500/10 backdrop-blur-md rounded-2xl p-8 mb-8 border border-yellow-500/30">
          <h2 className="text-3xl font-bold text-yellow-400 mb-6 flex items-center space-x-3">
          ...
          <div className="space-y-4 text-white/80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="bg-white/5 rounded-lg p-4 border border-yellow-500/20">
                <h3 className="text-yellow-400 font-semibold mb-2">Warning</h3>
            ...
            <p className="text-sm text-white/60 mt-4">
              ...
              support@pulsemind.com within 30 days.
            </p>
          </div>
        </div>
        ...
        <div className="bg-green-500/10 backdrop-blur-md rounded-2xl p-8 border border-green-500/30">
          ...
          <div className="space-y-4 text-white/80">
            ...
            <p className="text-sm text-white/60 mt-4">
              Interested in becoming a moderator? Email volunteer@pulsemind.com
            </p>
          </div>
        </div>
        ...
        <div className="text-center text-white/60 text-sm mt-12">
          ...
          <p className="mt-2">
            By using PulseMind, you agree to follow these Community Guidelines.
          </p>
        </div>
      </div>
    </div>
