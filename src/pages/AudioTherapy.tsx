          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl p-8 border border-blue-500/30 mb-8" data-aos="fade-up">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-white">Your Personalized Audio Journey</h2>
              </div>
              ...
              {therapyContext.reasoning && (
                <div className="bg-white/10 rounded-xl p-6 backdrop-blur-sm mt-6">
                  <div className="flex items-center space-x-2 mb-3">
                    <Music className="w-5 h-5 text-stress-yellow" />
                    <h3 className="text-white font-semibold">Why Audio Therapy?</h3>
                  </div>
            ...
            {/* AI-Powered Spotify Recommendations */}
            <SpotifyRecommendations 
              moodSummary={therapyContext.moodSummary}
              reasoning={therapyContext.reasoning}
              score={therapyContext.score}
            />
          </div>
        </section>
      )}
      ...
      <section id="audiobooks" className="py-20 px-4 bg-gray-850">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div data-aos="fade-up" data-aos-duration="800" className="bg-black rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center space-x-4 mb-4">
              <img 
                src="https://m.media-amazon.com/images/I/41vFDHMomNL._SL300_.jpg" 
          ...
          <div data-aos="fade-up" data-aos-duration="800" className="bg-black rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center space-x-4 mb-4">
              <img 
                src="https://m.media-amazon.com/images/I/41oKJQ1kJUL._SL300_.jpg" 
          ...
          <div data-aos="fade-up" data-aos-duration="800" className="bg-black rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center space-x-4 mb-4">
              <img 
                src="https://m.media-amazon.com/images/I/51j8OO5Ub3L._SL300_.jpg" 
          ...
          <div data-aos="fade-up" data-aos-duration="800" className="bg-black rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center space-x-4 mb-4">
              <img 
                src="https://m.media-amazon.com/images/I/51pkZXxOEtL._SL300_.jpg" 
          ...
          <div data-aos="fade-up" data-aos-duration="800" className="bg-black rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center space-x-4 mb-4">
              <img 
                src="https://m.media-amazon.com/images/I/51rJMl7LBML._SL300_.jpg" 
          ...
          <div data-aos="fade-up" data-aos-duration="800" className="bg-black rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center space-x-4 mb-4">
              <img 
                src="https://m.media-amazon.com/images/I/51j-p2daQ4L._SL300_.jpg" 
