      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                PulseMind is a wellness platform and <strong>not a substitute for professional medical or mental health care</strong>. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <a
            ...
            className="flex items-center space-x-3 bg-white/5 hover:bg-white/10 rounded-lg p-3 transition-all border border-white/10 hover:border-yellow-400/50"
          >
            ...
            <div>
              ...
              <p className="text-yellow-400 text-xs">1-800-273-8255</p>
            </div>
          </a>
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 text-white/60 text-xs border-t border-white/5 pt-4">
          <span>© 2025 PulseMind. All rights reserved.</span>
          <span>•</span>
          <a href="/community-guidelines" className="hover:text-yellow-400 transition-colors">Community Guidelines</a>
          <span>•</span>
          ...
          <span>•</span>
          <span className="text-yellow-400">18+ Only</span>
        </div>
      </div>
    </div>
  );
