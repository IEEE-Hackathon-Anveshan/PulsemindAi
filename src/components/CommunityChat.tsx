...
const CommunityChat: React.FC<CommunityChatProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-4xl h-[80vh] flex flex-col border border-yellow-500/30">
        {/* Header */}
                ...
                >
                  <div className={`max-w-[70%] ${isOwnMessage ? 'items-end' : 'items-start'} flex flex-col`}>
                    <div className="flex items-center space-x-2 mb-1">
                      ...
                      <span className={`text-sm ${isOwnMessage ? 'text-yellow-400' : 'text-gray-400'}`}>
        ...
        <form onSubmit={handleSendMessage} className="p-6 border-t border-gray-700">
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black p-3 rounded-full hover:from-yellow-600 hover:to-orange-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
