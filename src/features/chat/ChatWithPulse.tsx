...
function ChatWithPulse() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      text: "Hi! I'm PulseMind, your AI companion for mental wellness. How can I help you today?",
      sender: "bot",
      timestamp: new Date()
    },
  ]);
  ...
  if (!GOOGLE_API_KEY) {
    console.error('Google AI API key is missing! Please set VITE_GOOGLE_AI_API_KEY in your .env file');
  }
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const prompt = `You are PulseMind AI, an empathetic and professional AI assistant focused on mental wellness and stress management.
        ...
        <div className="bg-black/60 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 h-full flex flex-col relative overflow-hidden">
          ...
          <div className="p-6 border-b border-white/10 relative z-10">
            <div className="flex justify-between items-center">
              <h1 className="text-3xl font-bold text-white">Chat with PulseMind AI</h1>
